...
//    NON IMPLEMENTE
    ...
    /**
     * Remplace l'ancienne taille par le triple de celle-ci (en pixels).
     */
    ...
    {
        // this.efface(); // pourquoi est-ce inutile ici? Parce ça override l'ancient donc inutile de le supprimez.
