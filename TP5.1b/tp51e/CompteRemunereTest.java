...
public class CompteRemunereTest
{
    ...
    public void testClasse_1()
    {
        ...
        veref.V.failIfNot(); 
        veref.V.verifExtends( sFil, "Compte" );
    } // testClasse_1()
    ...
    public void testConstructeur_3()
    {
        ...
        veref.V.mesIfNot(); 
        // appel constructeur genere exception => a debugger :
        // double vValue1 = 12.34;
        // double vValue2 = 0.05;
        // veref.FieldContent vAtt1 = veref.V.getAttFTN( sCla, sAttType, "aSolde" );
        // veref.V.getAndVerifIns2( sCon, vAtt1, vValue1, sAtt, vValue2, true ); //object discarded
    } // testConstructeur_3()
