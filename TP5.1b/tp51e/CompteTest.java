...
public class CompteTest
{
    ...
    public void testConstructeur_3()
    {
        ...
        // le constructeur peut quand-me^me e^tre teste' :
    ...
    public void testAffecte_5()
    {
        ...
        if ( ! sAbstract ) {
            ...
            veref.V.failIfNot(); 
            double vValue3i = 10.125;
            double vValue3o = 10.13;
            // verif appel affecte dans constructeur
            vObj3 = veref.V.getAndVerifIns1io( sCon, sAtt, vValue3i, vValue3o );
        }
...
//        veref.V.verifCount(   sFil, "this.affecte\\(",    3     ); // this.affecte(
    ...
    public void testBilan_8()
    {
        ...
        veref.V.failIfNot();        
        veref.V.verifCount( sFil, "this.capitaliseUnAn\\(", 1 ); // this.capitaliseUnAn(
        veref.V.verifCount( sFil, "System.out.print", 2 ); // System.out.print
        // on pourrait aussi verifier ce qui est affiche' avec compareTerminal
    } // testBilan_8()
